    ...
    return (
        ...
        >
            <div className="space-y-12">
                <section>
                    <h2 className="text-xl font-serif text-luxury-charcoal mb-4">The Art of Preservation</h2>
                    <p>
                        Cinderela Charmora jewelry is designed to be cherished for a lifetime and passed down through
                        generations. To maintain the exquisite luster of your pieces, a little mindful care goes a long way.
                    </p>
                </section>

                <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="p-8 bg-luxury-beige/10 border border-luxury-gold/5">
                        <h3 className="text-sm uppercase tracking-widest text-luxury-gold mb-4 font-semibold">Wear with care</h3>
                    ...
                    <div className="p-8 bg-luxury-beige/10 border border-luxury-gold/5">
                        <h3 className="text-sm uppercase tracking-widest text-luxury-gold mb-4 font-semibold">Proper Storage</h3>
                        <p className="text-sm leading-relaxed">
                            When not in use, store your jewelry in the provided Cinderela Charmora pouch or a lined
                ...
                <section>
                    <h2 className="text-xl font-serif text-luxury-charcoal mb-4">Cleaning Your Treasures</h2>
                    <p>
