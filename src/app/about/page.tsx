...
export default function AboutPage() {
    return (
        <AppLayout>
            {/* Hero Section */}
            <section className="relative pt-48 pb-32 px-6 md:px-12 bg-charmora-pink/10">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <motion.h1
                        ...
                        className="text-5xl md:text-7xl text-charmora-purple font-serif mb-12 italic font-light"
                    >
                    ...
                    <motion.div
                        ...
                        className="aspect-[21/9] w-full bg-charmora-pink/30 relative overflow-hidden group"
                    >
                        <Image
            ...
            <section className="py-32 px-6 md:px-12 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-32">
                        ...
                        <div className="relative aspect-square md:aspect-[4/3] bg-charmora-beige overflow-hidden">
                            <Image
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        <div className="order-2 lg:order-1 relative aspect-square md:aspect-[4/3] bg-charmora-beige overflow-hidden">
                            <Image
                        ...
                        <div className="order-1 lg:order-2">
                            <span className="text-xs uppercase tracking-widest text-charmora-pink-dark font-medium mb-6 block font-sans">The Founder</span>
            ...
            {/* Values */}
            <section className="py-24 bg-charmora-pink/20 text-center px-6 md:px-12">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-8">
                        <div className="space-y-4">
                            <h4 className="text-lg font-serif text-charmora-purple">Artisanal Integrity</h4>
                            <p className="text-sm text-charmora-purple/60 font-sans">No shortcuts, only slow craftsmanship that respects the material.</p>
                        </div>
                        <div className="space-y-4">
                            <h4 className="text-lg font-serif text-charmora-purple">Premium Sourcing</h4>
                            <p className="text-sm text-charmora-purple/60 font-sans">Ethically sourced pearls and recycled golds for a kind luxury.</p>
                        </div>
                        <div className="space-y-4">
                            <h4 className="text-lg font-serif text-charmora-purple">Empowering Women</h4>
                            <p className="text-sm text-charmora-purple/60 font-sans">Designs that celebrate the feminine spirit in all its forms.</p>
                        </div>
                    </div>
                </div>
            </section>
